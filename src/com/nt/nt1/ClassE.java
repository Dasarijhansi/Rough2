...
public class ClassE {
	...
	public static void main(String[] args) {
		...
		al.add(new Employee("gh","tnb",105,30,6000));
		
      //al.stream().collect(Collectors.groupingBy(Employee::getEdepno,Collectors.counting())).forEach((a,b)->System.out.println(a+" "+b));;;
        
		al.stream().collect(Collectors.groupingBy(Employee::getEdepno,Collectors.summarizingInt
				(Employee::getSal))).forEach((a,b)->System.out.println(a+" "+b.getSum()));;
